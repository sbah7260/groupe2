...
texte.place(x=400, y='', )
ret = Button(fenetre6, text="<<Retour", font=('Calistoga', 8), bg="white",command=retour)
ret.place(x=5, y=30, )

id = Label(fenetre6, text="ID", bg="#ffffff", fg="#000000").place(x=50, y=80)

idchamp = Entry(fenetre6, bg="white", width=25, font=('Calistoga', 12))
idchamp.place(x=50, y=100, )

nom = Label(fenetre6, text="Nom", bg="#ffffff", fg="#000000").place(x=50, y=130)

nomchamp = Entry(fenetre6, bg="white", width=25, font=('Calistoga', 12))
nomchamp.place(x=50, y=150, )

prenom = Label(fenetre6, text="Prénom", bg="#ffffff", fg="#000000").place(x=50, y=180)

prechamp = Entry(fenetre6, bg="white", width=25, font=('Calistoga', 12))
prechamp.place(x=50, y=210, )

typro = Label(fenetre6, text="Type de produit", bg="#ffffff", fg="#000000").place(x=340, y=80)

typrochamp = Entry(fenetre6, bg="white", width=25, font=('Calistoga', 12))
typrochamp.place(x=340, y=100, )

adresse = Label(fenetre6, text="Adresse", bg="#ffffff", fg="#000000").place(x=340, y=130)

adreschamp = Entry(fenetre6, bg="white", width=25, font=('Calistoga', 12))
adreschamp.place(x=340, y=150, )

tel = Label(fenetre6, text="Téléphone", bg="#ffffff", fg="#000000").place(x=340, y=180)
...
pad = customtkinter.CTkButton(master=fenetre6, text="Ajouter", command=ajouter, text_font=('Calistoga', 11),
                              height=20, width=100, border_width=1, corner_radius=3, fg_color="#319BFE")
pad.place(x=150, y=250)
pad = customtkinter.CTkButton(master=fenetre6, text="Supprimer", text_font=('Calistoga', 11), command=supprimer,
                              height=20, width=100, border_width=1, corner_radius=3, fg_color="#319BFE")
pad.place(x=300, y=250)
pad = customtkinter.CTkButton(master=fenetre6, text="Modifier", text_font=('Calistoga', 11), command=modifier,
                              height=20, width=100, border_width=1, corner_radius=3, fg_color="#319BFE")
pad.place(x=450, y=250)
pad = customtkinter.CTkButton(master=fenetre6, text="Recupérer", text_font=('Calistoga', 11), command=recuperer,
                              height=20, width=100, border_width=1, corner_radius=3, fg_color="#319BFE")
pad.place(x=600, y=250)

# suivante et precedente
pad = Button(master=fenetre6, text="<<Précedente", font=('Calistoga', 11), command=quit, fg="#000000",
             width=11, bg="#ffffff")
